...
const readline = require('readline'),
 ...
 checkNumbersHigherThan = input => {

let filtered = bank.clients.filter(client =>{return client.totalBalance >= parseFloat(input)})
console.log(filtered)
 bank.methods.userInterface()
 }, 
 checkNumbersLowerThan = input => {
...
const bank = {
  ...
  console.log('Day 39 of code. (Day 38 updated version)')
            ...
            console.log('2: Vault')
            console.log('3: Client Account Search')
            console.log(`4: Withdraw a client's account `)
            console.log(`5: Deposit a client's account`)
            console.log(`6: Add client`)
            console.log(`7: Delete client.`)
            console.log(`8: Search account balances greater than amount.`)
            console.log(`9: Search account balances lesser than amount.`)
            ...
            rl.question(``, function (option) {
                ...
                switch (parseInt(option)) {
                    ...
                    rl.question('Check balances greater than:', desiredNumber => {
                        
                    
                        checkNumbersHigherThan(desiredNumber)
                        })

                        break;
                    case 9:
                         
                    rl.question('Check balances lesser than:', desiredNumber => {
                        
                    
                        checkNumbersLowerThan(desiredNumber)
                        })
